...
root.title("刘世卓8003119050 图像加解密")
ivInt = bytearray("AStringOfIV=", "utf-8")                                 #key1
keyInt = bytearray("liushizhuotailihailebahahahahaha", "utf-8")            #key2
...
b = Button(root, text="checkdecryimg", command=check_image)
b.place(x=300, y=210) 
...
b = Button(root, text="checkimg", command=check_image1)
b.place(x=300, y=110) 
